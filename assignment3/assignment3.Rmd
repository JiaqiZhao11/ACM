...
```{r}
source(here::here("Advanced-cog", "assignment3", "sc_agents.R"))
...
mod = cmdstan_model(here::here("Advanced-cog", "assignment3", "simple_Bayes.stan"))
fit = mod$sample(data = data1)


```
```{r}
mod_simpleBayes = cmdstan_model(here::here("Advanced-cog", "assignment3", "simple_Bayes.stan"), cpp_options = list(stan_threads = TRUE), stanc_options = list("O1"))
...
```{r}
fit = rstan::stan(file = here::here("Advanced-cog","assignment3", "simple_Bayes.stan"), data = data1)
